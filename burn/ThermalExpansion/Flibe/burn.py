...
class burn(object):
    ...
    def iterate_rho(self, thermal_expansion:bool=True) -> bool:
        #Create edge cases
        rho0:float = 1.0
        rho1:float = -1.0
    ...
    def get_rep_rate(self, thermal_expansion:bool=True, cleanup:bool=False) -> bool:
        run = 0
    ...
    def run_feedbacks(self,feedback:str='fs.dopp', thermal_expansion:bool=True, recalc:bool=False):
        '''
